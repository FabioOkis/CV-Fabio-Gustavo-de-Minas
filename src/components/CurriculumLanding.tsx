...
import { Paperclip, Eye, Upload, CheckCircle2, Award, GraduationCap, FileText, ShieldCheck } from 'lucide-react';
...
export const CurriculumLanding: React.FC<CurriculumLandingProps> = ({
  ...
  return (
    <div className="w-full max-w-[860px] mx-auto bg-white text-slate-900 shadow-xl sm:rounded-sm border border-slate-200/80 px-6 py-8 sm:px-12 sm:py-12 print:shadow-none print:border-none print:p-0 print:m-0 print:max-w-full font-sans">
      ...
      {/* Main Divider Line (darker as in screenshot) */}
      ...
      <section className="mb-4">
        ...
        <ul className="list-disc list-outside pl-4 space-y-0.5 text-[12.5px] sm:text-[13px] text-slate-800 leading-normal">
          <li>Windows 11, macOS e dispositivos móveis (iOS/iPadOS, Android)</li>
          <li>Microsoft Intune, Entra ID (Azure AD), Microsoft Defender — MDM e gestão de dispositivos corporativos</li>
          <li>Active Directory</li>
          <li>Microsoft 365 (SharePoint, Teams, OneDrive, Exchange) e iManage</li>
          <li>PowerShell (nível intermediário) para automação e troubleshooting</li>
          <li>Ferramentas de ITSM/Service Desk e acesso remoto</li>
          <li>ITIL v3 — Governança de TI, gestão de incidentes e SLA e HDI technical support</li>
          <li>iManage — Administração de Data Room e compartilhamento seguro de documentos confidenciais</li>
          <li>Gestão de backup, inventário de ativos e documentação técnica</li>
        </ul>
      </section>
      ...
      <section className="mb-4">
        ...
        <hr className="border-t border-slate-300 my-1" />
        <ul className="list-disc list-outside pl-4 space-y-0.5 text-[12.5px] sm:text-[13px] text-slate-800 leading-normal">
          <li>Atendimento consultivo a usuários de alto perfil, com discrição e confidencialidade</li>
          <li>Comunicação técnica clara com usuários e stakeholders</li>
          <li>Senso de urgência e priorização em ambientes de alta pressão</li>
          <li>Resolução de problemas complexos e análise de causa raiz</li>
          <li>Organização, disciplina e produção de documentação técnica</li>
        </ul>
      </section>
      ...
      <section className="mb-4">
        ...
        <div className="mb-3.5">
          ...
          <ul className="list-disc list-outside pl-4 space-y-0.5 text-[12px] sm:text-[12.5px] text-slate-800 leading-normal">
            <li>Responsável pelo suporte de segundo nível e administração de TI no escritório Pinheiro Guimarães Advogados.</li>
            <li>Administração de usuários, acessos, grupos e políticas de segurança no Active Directory e no ecossistema Microsoft 365 (SharePoint, Teams, OneDrive e Exchange).</li>
            <li>Gestão e suporte avançado ao iManage, sistema de gerenciamento de documentos jurídicos, garantindo organização e confidencialidade de peças e processos.</li>
            <li>Administração de ambientes de Data Room para compartilhamento seguro de documentos em auditorias e transações financeiras.</li>
            <li>Execução e monitoramento de rotinas críticas de TI: políticas de backup, inventário de ativos e documentação técnica para usuários.</li>
            <li>Diagnóstico e resolução de problemas de hardware, software, redes e impressão, com interface direta a fornecedores para demandas complexas.</li>
          </ul>
        </div>
        ...
        <div className="mb-3.5">
          ...
          <ul className="list-disc list-outside pl-4 space-y-0.5 text-[12px] sm:text-[12.5px] text-slate-800 leading-normal">
            <li>Liderança no suporte técnico especializado em um dos maiores escritórios de advocacia do Brasil, em ambiente de alta criticidade e confidencialidade.</li>
            <li>Implementação de soluções proativas para problemas recorrentes, reduzindo o volume de chamados repetitivos.</li>
            <li>Administração do Active Directory e Microsoft 365, garantindo acesso seguro e ininterrupto para mais de 1.500 usuários.</li>
          </ul>

          {/* Carta de Recomendação Pinheiro Neto */}
        ...
        <div className="mb-1">
          ...
          <ul className="list-disc list-outside pl-4 space-y-0.5 text-[12px] sm:text-[12.5px] text-slate-800 leading-normal">
            <li>Gerenciamento de chamados de 1º e 2º níveis para o Tribunal Regional do Trabalho, com 95% de cumprimento de SLAs.</li>
            <li>Melhoria na documentação de soluções, resultando em redução de 20% no tempo de resolução de tickets recorrentes.</li>
            <li>Suporte remoto e presencial a sistemas críticos do tribunal, minimizando impactos operacionais em períodos de pico.</li>
          </ul>
        </div>
      </section>
