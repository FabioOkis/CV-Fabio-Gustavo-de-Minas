...
import { GuillocheCertificateBorder } from './GuillocheCertificateBorder';
        ...
        <div className="flex items-center justify-between">
          ...
          {isAdmin && (
            <button
              ...
              className="no-print inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-blue-50 hover:bg-blue-100 text-blue-700 border border-blue-200 text-xs font-semibold shadow-2xs transition-all cursor-pointer active:scale-95"
            >
